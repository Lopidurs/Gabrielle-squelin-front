    ...
    return (
        <div className={"footer"}>
            ...
            <div className={"center"}>
                <svg width="119.07mm" height="100.18mm" version="1.1" viewBox="0 0 119.07 100.18"
            ...
            <div className={"right"}>
                ...
                <a href={"https://www.youtube.com/channel/UCmIHM0130L4oG4Q01S_nrVg"}>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         ...
                         fill="currentcolor">
                        <path
                            d="M61.115,18.856C63.666,21.503,64,25.709,64,36s-0.334,14.497-2.885,17.144C58.563,55.791,55.906,56,36,56	s-22.563-0.209-25.115-2.856C8.334,50.497,8,46.291,8,36s0.334-14.497,2.885-17.144S16.094,16,36,16S58.563,16.209,61.115,18.856z M31.464,44.476l13.603-8.044l-13.603-7.918V44.476z"></path>
                    </svg>
                </a>
            </div>
        </div>
